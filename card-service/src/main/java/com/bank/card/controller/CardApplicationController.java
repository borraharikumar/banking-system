...
public class CardApplicationController {
	...
	public Integer cardApplication(@RequestBody CardApplicationRequest application) throws Exception {
		AccountValidationRequest valRequest = new AccountValidationRequest(
				application.getCardApplication().getAccountNo(), application.getTxnPassword());
	...
	public ResponseEntity<List<CardApplication>> getCardApplication(@PathVariable LocalDate fromDate,
